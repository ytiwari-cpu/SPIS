...
export default function AdminAppeals() {
  ...
  const canExport = hasPermission('ADMIN.AUDITLOGS.EXPORT') // Using audit logs export for general export
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <PageHeader
          title="Appeals"
          subtitle={`${filteredAppeals.length} appeals in the system`}
          actions={
            canExport && (
              <ActionButton
