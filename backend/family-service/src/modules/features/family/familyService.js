...
export class FamilyService {
  ...
  async get(uuid) {
    ...
    const [membersRes, addressRes, mailingAddressRes, docsRes] = await Promise.all([
      this.repo.getMembersByFamily(uuid),
      this.repo.getAddressByFamily(uuid),
      this.repo.getMailingAddressByFamily(uuid),
    ...
    return {
      ...
      mailing_address: mailingAddressRes.data || null,
