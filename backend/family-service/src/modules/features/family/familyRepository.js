...
export class FamilyRepository {
  ...
  async getAddressByFamily(familyUuid) {
    return supabase
      .from('address').select('*')
      .eq('entity_type', 'FAMILY').eq('entity_id', familyUuid).eq('address_type', 'PERMANENT').maybeSingle()
  }

  async getMailingAddressByFamily(familyUuid) {
    return supabase
      .from('address').select('*')
      .eq('entity_type', 'FAMILY').eq('entity_id', familyUuid).eq('address_type', 'MAILING').maybeSingle()
  }
