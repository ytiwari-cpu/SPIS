...
const listByFamily = {
  ...
  verb:       'GET',
  handler:    { controller: MemberController, method: 'listByFamily', arguments: ['request:params'] },
  middleware: auth,
...
const get = {
  path:       '/:id',
  verb:       'GET',
  handler:    { controller: MemberController, method: 'get', arguments: ['request:params'] },
  middleware: auth,
  permission: { anyOf: ['ADMIN.FAMILIES.VIEW', 'CITIZEN.FAMILY.VIEW'] },
}
...
const create = {
  path:       '/',
  verb:       'POST',
  handler:    { controller: MemberController, method: 'create', arguments: ['request:body', 'user'] },
  middleware: auth,
...
const update = {
  path:       '/:id',
  verb:       'PATCH',
  handler:    { controller: MemberController, method: 'update', arguments: ['request:params', 'request:body', 'user'] },
  middleware: auth,
  permission: { anyOf: ['ADMIN.FAMILIES.EDIT', 'CITIZEN.FAMILY.EDIT'] },
  request:    {
    body: z.object({
...
const remove = {
  path:       '/:id',
  verb:       'DELETE',
  handler:    { controller: MemberController, method: 'remove', arguments: ['request:params', 'user'] },
  middleware: auth,
...
const lookup = {
  path:       '/lookup',
  verb:       'GET',
  handler:    { controller: MemberController, method: 'lookup', arguments: ['request:query'] },
  middleware: [],
}
